...
from com.AI.MingGeTrain.disProject.wavenet_asr_v2.oneNodeWavenet.utils import SpeechLoader
...
def speech_to_text():
    ...
    speech_loader = SpeechLoader(wav_path, label_file=label_file, batch_size=1, n_mfcc=n_mfcc)
    # load model
